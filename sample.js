...
veryOldInventors = inventors.filter ((item) => item.year < 1600 && item.year > 1500);
...
// Complete the exercise in the space below:
firstLast = people.map((peop) => {
    return peop.split(", ")[1] + " " + peop.split(", ")[0];
})
...
// Complete the exercise in the space below:
isAdultPresent = devs.some((dev)=> dev.year > new Date().getFullYear() - 18 )
...
// Complete the exercise in the space below:
isEveryone19OrOlder = devs.every((dev)=> dev.year > new Date().getFullYear() - 19 )
...
// Complete the exercise in the space below:
idx = comments.findIndex((element)=> element.id === 123523);
...
console.log("_________________________________LEVEL UP_________________________________________");
...
// Complete the exercise in the space below:
totalYearsLived = inventors.reduce((accumulator, currentValue) => accumulator + (currentValue.passed - currentValue.year),0);
...
// Complete the exercise in the space below:
travelMethodCounts = travelMethods.reduce((accumulator, vehicle) => {
